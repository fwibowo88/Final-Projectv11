...
<div class="container-fluid">
  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      <div class="col-sm-10">
        <h3 class="card-title">All Master Department in Database</h3>
      </div>
      <div class="col-sm-1 float-right">
        <a class="btn btn-primary" href="{{route('department.create')}}">Add Data</a>
      </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
          ...
          <td>
            <form role="form" action="{{route('department.destroy',$department->id)}}" method="POST">
              ...
              <div class="btn-group">
                ...
                <a class="btn btn-primary" href="{{route('department.edit',$department->id)}}"><i class="fa fa-edit"></i></a>
