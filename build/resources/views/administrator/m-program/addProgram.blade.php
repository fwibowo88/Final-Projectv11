  ...
  <div class="card card-primary">
    ...
    <div class="card-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="programName" placeholder="Ex : TKJ" required>
      </div>
      <div class="form-group">
        <label>Description</label>
        <textarea class="form-control" name="programDescription" rows="3" placeholder="Program Description . . . "></textarea>
      </div>
    </div>
    <!-- /.card-body -->
